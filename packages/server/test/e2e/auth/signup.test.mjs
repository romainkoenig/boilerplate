...
describe.skip('Signup', async () => {
  const firebaseMock = {
    createUser: () => ({ email: 'john.mock@gmail.com' }),
  ...
  test('should get 200 as a response when user register with correct arguments', async (ctx) => {
    ctx.mock.method(adminFirebaseService, 'createUser', firebaseMock.createUser)
    ctx.mock.method(adminFirebaseService, 'createCustomToken', firebaseMock.createCustomToken)
    assert.strictEqual(adminFirebaseService.createUser.mock.calls.length, 0)
    ...
    assert.strictEqual(adminFirebaseService.createUser.mock.calls.length, 1)
    assert.strictEqual(adminFirebaseService.createCustomToken.mock.calls.length, 1)

    assert.equal(response.statusCode, 201)
    assert.deepEqual(response.json(), { token: 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImE1MWJiNGJkMWQwYzYxNDc2ZWIxYjcwYzNhNDdjMzE2ZDVmODkzMmIiLCJ0eXAiOiJKV1QifQ..Wp-G07TPAkAQ93c4FWstJKuoHs6rxqBhr4dmM1dboDMPTd3p5l-xeIwnUSV1FIWAbWadlDLQ4DnM8N2sYK273DElc8k_1JSh8bzCjHz4_M1iDHtiHnDW28sw-qo9JArpbSTLyv8QqK8XSSfU9a1-mK66IMjn9Q0OL1LKru_wwZJfoKicgFgvzz5YN5mj-IxqR1TTPXTSUGnfVMIAQgNLNVM60GTjaY5HTOgqE1A16qx2pfPIR1FSQRmvHd9ou18yLJt7ZyeAM7kO2fET3rGoRQbF3qOnPJCa3EfpSe1G0yGKh2y4SsI7dGZKMQzjBe3oGLu3m99vY2Dgux96LRp99Q' })
  })
})
